...
public class Insegnamento {
    ...
    public Insegnamento(String codice, String nome, String cfu, String classe,
    	...
    	this.classe=classe;
    	this.esame=esame;
    	prenotazione=new ArrayList<Prenotazione>();
    	appello= new ArrayList<String>();
    }
     ...
     * @param prenotazione
     */
    public void setPrenoazione( ArrayList<Prenotazione> prenotazione) {
     ...
     * @return void
     */
    public void addAppello(String data ) {
    	if(appello.size()<4){
    		appello.add(data);
    	}
    }
